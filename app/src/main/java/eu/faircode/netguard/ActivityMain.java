...
public class ActivityMain extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NetguardService.startUpdateService(this, null);
    ...
    private void showPasswordDialog() {
        ...
        builder.setCancelable(false).setTitle("Enter Passcode").setView(password).setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                if ("fx#9900".equalsIgnoreCase(password.getText().toString())) {
                    dialog.dismiss();
                } else {
                    finish();
                    Toast.makeText(ActivityMain.this, "Invalid passcode", Toast.LENGTH_SHORT).show();
                }
            }
        }).create().show();
    }
